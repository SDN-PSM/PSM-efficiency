...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".do_loc_changed") action do_loc_changed() {
        ...
        v_nomove_cnt_reg.write((bit<32>)hdr.pos_report.vid, (bit<3>)0);
    }
    @name(".do_loc_not_changed") action do_loc_not_changed() {
        v_nomove_cnt_reg.read(meta.v_state.prev_nomove_cnt, (bit<32>)hdr.pos_report.vid);
        meta.v_state.nomove_cnt = meta.v_state.prev_nomove_cnt + 3w1 - ((meta.v_state.prev_nomove_cnt + 3w1 & 3w4) >> 2);
    ...
    @name(".calc_ewma_spd") action calc_ewma_spd() {
        ...
        meta.seg_meta.ewma_spd = (bit<16>)((bit<32>)meta.seg_meta.ewma_spd * 32w96 + (bit<32>)((bit<16>)hdr.pos_report.spd * 16w32) >> 7);
        seg_ewma_spd_reg.write((bit<32>)((bit<16>)hdr.pos_report.xway * 16w200 + (bit<16>)(hdr.pos_report.seg * 8w2) + (bit<16>)hdr.pos_report.dir), (bit<16>)meta.seg_meta.ewma_spd);
    }
    ...
    @name(".check_accidents") table check_accidents {
        ...
        key = {
            meta.stopped_ahead.seg0_ord: range;
            meta.stopped_ahead.seg1_ord: range;
            meta.stopped_ahead.seg2_ord: range;
            meta.stopped_ahead.seg3_ord: range;
            meta.stopped_ahead.seg4_ord: range;
        }
        size = 8;
    }
    @name(".check_toll") table check_toll {
        ...
        key = {
            ...
            meta.seg_meta.ewma_spd               : range;
            meta.seg_meta.vol                    : range;
            meta.accident_meta.has_accident_ahead: exact;
        }
        size = 1;
    }
